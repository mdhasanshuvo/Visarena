...
const Footer = () => {
    return (
        <div className="bg-neutral">
            <footer className="footer text-neutral-content p-8 pb-10 container mx-auto">
                <aside>
                ...
                <nav>
                    ...
                    <a href="/allVisa" className="link link-hover">Visas</a>
                </nav>
                <nav>
            ...
            <footer className="container mx-auto text-neutral-content items-center pb-4 px-8">
                <aside className="text-center">
                    <p>Copyright © {new Date().getFullYear()} - All rights reserved by Visarena</p>
                </aside>
            </footer>
        </div>
    );
